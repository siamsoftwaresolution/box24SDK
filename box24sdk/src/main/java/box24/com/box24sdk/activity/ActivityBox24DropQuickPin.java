...
public class ActivityBox24DropQuickPin extends Activity {
...
//        ImageView imageView = (ImageView) findViewById(R.id.image);
        ...
        if(page==0){
            tv_title.setText(getString(R.string.QuickPinDropOff));
        }else{
            tv_title.setText(getString(R.string.QuickPinPickUp));
        }
...
//        Picasso.with(this).load(image).into(imageView);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(context, ActivityBox24Menu.class);
